...
class Epidemic {
  public:
    ...
    int get_people_becoming_infected_today() {
        return people_becoming_infected_today;
    }
    int get_total_people_ever_infected() {
        return total_people_ever_infected;
    }
    int get_people_becoming_symptomatic_today() {
        return people_becoming_symptomatic_today;
    }
    int get_people_with_current_symptoms() {
        return people_with_current_symptoms;
    }
    double get_RR() {
        return RR;
    }
    ...
    double get_symptomatic_attack_ratio() {
        return symptomatic_attack_ratio;
    }
    ...
    int get_symptomatic_incidence() {
        return symptomatic_incidence;
    }
    int get_prevalence_count() {
        return prevalence_count;
    }
