...
#ifndef _PHIL_ACTIVITIES_H
#define _PHIL_ACTIVITIES_H
  ...
  public:
    ...
    static const char * activity_lookup(int idx) {
        ...
        case CLASSROOM_ACTIVITY:
            return "Classroom";
        case WORKPLACE_ACTIVITY:
            return "Workplace";
        case OFFICE_ACTIVITY:
            return "Office";
        default:
            Utils::phil_abort("Invalid Activity Type", "");
        }
    }
    /**
    ...
    int get_sick_days_absent() {
        return my_sick_days_absent;
    }
    int get_sick_days_present() {
        return my_sick_days_present;
    }
