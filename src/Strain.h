...
#ifndef _PHIL_STRAIN_H
#define _PHIL_STRAIN_H
...
class Strain_Data {
  ...
  public:
    ...
    short unsigned int & operator[](int i) {
        return data[ i ];
    }
    const short unsigned int & operator[](int i) const {
        return data[ i ];
    }
...
class Strain {
  public:
    ...
    int get_num_data_elements() {
        return strain_data.get_num_elements();
    };
    int get_data_element(int i) {
        return strain_data.get_data_element(i);
    };

    Strain_Data & get_data() {
        return strain_data;
    }
    const Strain_Data & get_strain_data() {
        return strain_data;
    }
