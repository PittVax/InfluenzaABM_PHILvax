...
class Geo_Utils {
  public:
    ...
    static fred::geo get_longitude(double x) {
        return (fred::geo)(x / km_per_deg_longitude - 180.0);
    }
    static fred::geo get_latitude(double y)  {
        return (fred::geo)(y / km_per_deg_latitude - 90.0);
    }
