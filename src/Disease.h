...
#ifndef _PHIL_Disease_H
#define _PHIL_Disease_H
...
class Disease {
  public:
    ...
    void become_susceptible(Person * person) {
        epidemic->become_susceptible(person);
    }
    void become_unsusceptible(Person * person) {
        epidemic->become_unsusceptible(person);
    }
    void become_exposed(Person * person) {
        epidemic->become_exposed(person);
    }
    void become_infectious(Person * person) {
        epidemic->become_infectious(person);
    }
    void become_uninfectious(Person * person) {
        epidemic->become_uninfectious(person);
    }
    void become_symptomatic(Person * person) {
        epidemic->become_symptomatic(person);
    }
    ...
    void increment_cohort_infectee_count(int day) {
        epidemic->increment_cohort_infectee_count(day);
    }
    ...
    double get_infectivity_threshold() {
        return infectivity_threshold;
    }
    double get_symptomaticity_threshold() {
        return symptomaticity_threshold;
    }
  ...
  private:
    ...
    double immunity_loss_mu;
    double immunity_loss_sigma;
