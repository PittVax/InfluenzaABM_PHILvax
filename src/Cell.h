...
class Cell : public Abstract_Cell {
  public:
     ...
     */
    int get_target_households() {
        return target_households;
    }

    /**
     * @return the target_popsize
     */
    int get_target_popsize() {
        return target_popsize;
    }
