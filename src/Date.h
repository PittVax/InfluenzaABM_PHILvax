...
class Date {
  public:
    ...
    string get_day_of_week_string() {
        return this->get_day_of_week_string(0);
    }
    string get_day_of_week_string(int t);
    int get_epi_week() {
        return this->get_epi_week(0);
    }
    int get_epi_week(int t);
    int get_epi_week_year()  {
        return this->get_epi_week_year(0);
    }
    int get_epi_week_year(int t);
    int get_days_since_jan_1_epoch_year() {
        return this->days_since_jan_1_epoch_year;
    }
    void advance();
    ...
    static int get_epoch_start_year() {
        return Date::EPOCH_START_YEAR;
    }
  private:
