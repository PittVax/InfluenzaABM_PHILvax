...
#ifndef _PHIL_VACCINE_H
#define _PHIL_VACCINE_H
...
class Vaccine {
  public:
    ...
    Vaccine(string _name, int _id, int _disease,
            int _total_avail, int _addtional_per_day, int _start_day,
            int num_strains, int *_strains,
            Timestep_Map * production_);
    ~Vaccine();
    ...
    int get_additional_per_day(int day);
