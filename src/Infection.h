...
class Infection {
  ...
  public:
     ...
     */
    bool is_infectious() {
        return infectivity > trajectory_infectivity_threshold;
    }
     ...
     */
    bool is_symptomatic() {
        return symptoms > trajectory_symptomaticity_threshold;
    }
    ...
    void mutate(int old_strain, int new_strain, int day) {
        trajectory->mutate(old_strain, new_strain, day);
    }
