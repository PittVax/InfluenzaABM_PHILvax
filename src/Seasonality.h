...
#ifndef _PHIL_SEASONALITY_H
#define _PHIL_SEASONALITY_H
...
class Seasonality {
  ...
  public:
    ...
    //~Seasonality(Abstract_Grid * grid);
    void update(int day);
    double get_seasonality_multiplier_by_lat_lon(phil::geo lat, phil::geo lon, int disease_id);
