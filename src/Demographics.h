...
#ifndef _PHIL_DEMOGRAPHICS_H
#define _PHIL_DEMOGRAPHICS_H
...
class Demographics {
  public:
     ...
     */
    bool is_householder() {
        return relationship == Global::HOUSEHOLDER;
    }
     ...
     */
    short int get_birth_day_of_year() {
        return this->birth_day_of_year;
    }

    /**
     * @return the agent's birth_year
     */
    short int get_birth_year() {
